    ...
    def model_forward(
        ...
        **kwargs,
        ...
        if inference:
            ...
            cv2.imwrite('coresimg/'+kwargs["image_paths"][0].split('/')[-1], image)
            for p,gt_i in enumerate(masks_list[0]):
                ...
                tmp_dir = 'coresimg/'+kwargs["image_paths"][0].split('/')[-1].split('.')[0]+'_gt'+str(p)
        ...
        for i in range(len(pred_embeddings)):
            ...
            low_res_masks = low_res_masks.to(pred_embeddings[i].dtype)
