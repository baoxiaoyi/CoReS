...
from model.CORES import CORESForCausalLM
...
def parse_args(args):
    ...
    parser.add_argument("--val_dataset2", default="pascal_part||paco_lvis||part_imagenet", type=str)
...
def main(args):
    ...
    if args.auto_resume and len(args.resume) == 0:
        resume = os.path.join(args.log_dir, "ckpt_model/5")
...
def validate(val_loader, model_engine, epoch, writer, args,partflag):
    ...
    model_engine.eval()
    '''mingxian = [
"6069410_2ec241213c_o",
"22758113_b762c61e62_o",
"26275329_8ebc22fa03_o",
"33343263_c4f465d900_o",
"45920253_3c95aa7de0_o",
"58602728_87be62e877_o",
"85090713_b8f9ab3cc1_o",
"107574647_0269b8ec6b_o",
"143736875_1c8a4d0588_o",
"206674234_4cb520b13d_o",
"218405745_60bbfbab1a_o",
"426705104_c773321b5f_o",
"500834330_1a4c91c820_o",
"750173696_2727ac49bf_o",
"764271537_cf309cdeaf_o",
"2776332001_1227fb6349_o",
"3872469525_4a26003ccf_o",
"4998901970_b973aa3d94_o",
"7872473112_5c62c847fd_o",
"7923581794_9382d672f4_o",
"8131485383_f3180e425a_o",
"8451614203_e6484a2cb4_o",
"11042914985_f365aa88e4_o",
"11536014003_e8d6cc013b_o",
"scene0234_00_0",
"scene0295_00_0",
"scene0684_00_0",
"100706138_4dd951b10b_o",
"170313928_dc2aed12be_o",
"240284336_06aace2ef6_o",
"862728645_7aacaa218d_o",
"7667955824_23f01c253a_o",
"8087061900_51c823704a_o",
"34195937_dda257475e_o",
"56528009_0999f9f919_o",
"806877307_f4a8cdb548_o",
"862728645_7aacaa218d_o",
"7573264258_ec91a14d84_o",
"7676818244_d1a537f909_o",
"7939894288_3028c8874a_o",
"8012904007_3faa1f7795_o"]'''
    
    for input_dict in tqdm.tqdm(val_loader):
        torch.cuda.empty_cache()

        '''if input_dict["image_paths"][0].split('/')[-1].split('.')[0] not in mingxian:
            continue
        else:
            image = cv2.imread(input_dict["image_paths"][0])
            for p,gt_i in enumerate(input_dict["masks_list"][0]):
                ...
                tmp_dir = 'gt_cores/'+input_dict["image_paths"][0].split('/')[-1].split('.')[0]+'_gt'+str(p)       
